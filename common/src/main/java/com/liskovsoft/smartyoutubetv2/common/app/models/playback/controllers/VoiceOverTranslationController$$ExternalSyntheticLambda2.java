...
implements Runnable {
    ...
    public final void run() {
        this.f$0.lambda$runTranslateRequest$2$com-liskovsoft-smartyoutubetv2-common-app-models-playback-controllers-VoiceOverTranslationController(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
    }
}
