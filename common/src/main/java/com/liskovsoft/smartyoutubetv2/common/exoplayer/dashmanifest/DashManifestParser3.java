package com.liskovsoft.smartyoutubetv2.common.exoplayer.dashmanifest;
...
public class DashManifestParser3 {
    ...
    private SegmentList parseSegmentList(MediaFormat format) {
        ...
        return new SegmentList(initialization, timescale, presentationTimeOffset,
                startNumber, duration, timeline, /* availabilityTimeOffsetUs= */ 0, segments,
    ...
    protected Representation buildRepresentation(
        ...
        Format.Builder formatBuilder = format.buildUpon();
        if (label != null) {
        ...
        if (!drmSchemeDatas.isEmpty()) {
            ...
            DrmInitData drmInitData = new DrmInitData(drmSchemeType, new ArrayList<>(drmSchemeDatas));
    ...
    private static Format.Builder formatBuilder() {
