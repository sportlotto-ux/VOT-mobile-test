...
import androidx.media3.exoplayer.source.dash.DashSegmentIndex;
import androidx.media3.exoplayer.source.dash.manifest.AdaptationSet;
...
import androidx.media3.exoplayer.source.dash.manifest.Descriptor;
import androidx.media3.exoplayer.source.dash.manifest.Period;
import androidx.media3.exoplayer.source.dash.manifest.RangedUri;
import androidx.media3.exoplayer.source.dash.manifest.Representation;
import androidx.media3.exoplayer.source.dash.manifest.Representation.MultiSegmentRepresentation;
import androidx.media3.exoplayer.source.dash.manifest.SegmentBase.MultiSegmentBase;
import androidx.media3.exoplayer.source.dash.manifest.SegmentBase.SegmentList;
import androidx.media3.exoplayer.source.dash.manifest.SegmentBase.SegmentTimelineElement;
